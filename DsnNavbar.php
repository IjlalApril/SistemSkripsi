        ...
        <div class="nav">
            ...
            <div class="collapse" id="skripsi" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                    <a class="nav-link" href="pages/dsnskripsisaya.php">Skripsi Mahasiswa Saya</a>
                </nav>
            </div>
            ...
            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                    <a class="nav-link" href="pages/dsnbimbingansaya.php">Bimbingan Saya</a>
                    <a class="nav-link" href="pages/dsnlaporanbimbingan.php">Laporan Bimbingan</a>
                </nav>
            </div>
        </div>
    </div>
