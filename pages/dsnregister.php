...
<head>
    ...
    ?>
    <title>Register Dosen - Sistem Skripsi Unsam</title>
</head>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Buat Akun Dosen</h3>
                                </div>
                                <div class="card-body">
                                    <form action="../includes/dsnregister.inc.php" method="POST" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="dsnlogin.php">Sudah punya akun? Pergi ke Login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
