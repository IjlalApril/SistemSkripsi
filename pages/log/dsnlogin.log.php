...
<head>
    ...
    ?>
    <title>Login Dosen - Sistem Skripsi Unsam</title>
</head>
                        ...
                        <div class="col-lg-5">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <h3 class="text-center font-weight-light my-4">Login Dosen</h3>
                                </div>
                                <div class="card-body">
                                    <form action="../includes/dsnlogin.inc.php" method="POST">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="dsnregister.php">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
