...
<head>
    ...
    ?>
    <title>Login Mahasiswa - Sistem Skripsi Unsam</title>
</head>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-5">
                            ...
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="../includes/mhslogin.inc.php" method="POST">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="mhsregister.php">Need an account? Sign up!</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
